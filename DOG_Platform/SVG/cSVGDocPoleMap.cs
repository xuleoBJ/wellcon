...
{
    class cSVGDocPoleMap:cBaseMapSVG
    {

        public cSVGDocPoleMap(int width,int height, int iDX, int iDY)
        ...
        public XmlElement addgPoleBaseMap(int x0, int y0,int r)
        {
            ...
            for (int i = 1; i <= 9; i++)
            {
                ...
                gMainCircle.SetAttribute("stroke-width", "0.5");
                ...
                if (i < 9)
                {
                    ...
                    gYTickText.SetAttribute("stroke-width", "0.5");
